# Getting Crossplay v14.0 onto GitHub & Claude Code
...
Unzip `Crossplay_v14-0__GitHub_Ready.zip` somewhere on your computer.
Then in your terminal:

```bash
# Navigate to wherever you unzipped it
cd /path/to/crossplay
...
git commit -m "Crossplay v14.0 - initial commit"
...
```bash
cd /path/to
zip -r crossplay_latest.zip crossplay/ -x "*__pycache__*" "*.bin" "*.json"
```
