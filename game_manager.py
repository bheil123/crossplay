...
from crossplay_v9.lookahead import evaluate_with_lookahead
from crossplay_v9.parallel_eval import evaluate_with_lookahead_parallel
...
class Game:
    ...
    def __init__(self, state: Optional[GameState] = None):
        ...
        from crossplay_v9.mc_calibrate import calibrate
    ...
    def show_status(self):
        ...
        from crossplay_v9.power_tiles import format_power_tile_display, get_power_tiles_in_pool
    ...
    def show_existing_threats(self, top_n: int = 10, force_refresh: bool = False):
        ...
        """
        from crossplay_v9.real_risk import analyze_existing_threats
    ...
    def analyze(self, rack: str = None, top_n: int = 15, lookahead_n: int = None):
        ...
        try:
            from crossplay_v9.move_finder_c import find_all_moves_c, is_available
            if is_available():
                t_mg = time.time()
        ...
        for i, move in enumerate(candidates):
            ...
            from crossplay_v9.opening_heuristics import evaluate_opening_heuristics
    ...
    def _show_2ply_analysis(self, rack: str, top_moves: list, unseen: dict, bag_empty: bool, lookahead_n: int = None, exchange_candidates: list = None):
        ...
        if lookahead_n is None:
            from crossplay_v9.mc_calibrate import compute_adaptive_n
            ...
            from crossplay_v9.mc_calibrate import estimate_throughput
        ...
        print("=" * 70)
        if blank_count > 1:
            from crossplay_v9.mc_eval import _blank_correction_factor
    ...
    def _show_catchup_advice(self, unseen: dict, total_unseen: int, results: list):
        ...
        from crossplay_v9.power_tiles import get_power_tiles_in_pool, prob_draw_any_power_tile
    ...
    def record_opponent_move(self, word: str, row: int, col: int, horizontal: bool, 
        ...
        from crossplay_v9.scoring import calculate_move_score
        from crossplay_v9.config import TILE_VALUES
...
class GameManager:
    ...
    def _vs_ai_mode(self):
        ...
        from crossplay_v9.play_game import CrossplayGame
        game = CrossplayGame()
        game.play()
